            ...
            <main class="w-full px-3 lg:w-3/4">
                <x-card.default class="flex flex-col gap-6">
                    ...
                    <div>
                        ...
                        <x-form.input type="text" wire:model="title" class="w-full border rounded p-2" disabled/>
                        <small class="text-primary-muted">{{ __('The title can not be changed.') }}</small>
                ...
                <x-card.side>
                    ...
                    <div class="relative group" wire:ignore.self>
                        ...
                        <img
                                ...
                                src="{{
                                    $new_featured_image
                                        ? $new_featured_image->temporaryUrl()
                                        : ($featured_image
                                            ? Storage::url($featured_image)
                        ...
                        <div class="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity">
                            <x-form.label for="new_featured_image"
                                ...
                                <input type="file"
                                       ...
                                       class="hidden"
                                       accept="image/*"
                                       wire:model.live="new_featured_image"
                                />
                            </x-form.label>
                        </div>
                        ...
                        <div class="absolute inset-0 flex items-center justify-center bg-background/90 text-white text-sm rounded-lg"
                             wire:loading.flex
                             wire:target="new_featured_image">
                        ...
                        <x-form.error for="new_featured_image" class="mt-2"/>
                    </div>
                </x-card.side>
