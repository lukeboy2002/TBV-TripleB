<div>
    <div class="flex items-center gap-2 mr-2">
        @can('update', $post)
            <x-link.icon href="{{ route('posts.edit', $post->slug) }}" icon="edit" class="text-edit"/>
        @endcan
                ...
                <div class="flex justify-between items-center h-screen max-w-md mx-auto">
                    <div class="bg-background border border-secondary/30 relative rounded-lg shadow-sm w-full">
                        ...
                        <div class="p-4 md:p-5">
                            ...
                            <h3 class="mb-5 text-lg font-normal text-primary-muted">Weet je zeker dat je dit bericht en
                                alle bijbehorende reacties wilt verwijderen?
                            </h3>
