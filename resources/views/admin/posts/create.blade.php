<x-admin-layout>
    ...
    <x-cards.default>
        <form method="POST" action="{{ route('admin.posts.store') }}" enctype="multipart/form-data" class="space-y-6">
            @csrf
            <div>
                <x-forms.label for="image" value="Featured Image" />
            ...
            <div class="flex justify-between space-x-6">
                <div class="w-1/2">
                    ...
                    <x-forms.input type="text" name="title" id="title" :value="old('title')" required />
            ...
            <div class="flex justify-between items-center space-x-6">
                <div class="w-1/2">
                    ...
                    <x-forms.input type="date" name="published_at" id="published_at" :value="old('published_at')" />
