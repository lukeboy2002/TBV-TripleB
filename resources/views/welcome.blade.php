<x-app-layout>
    <article class="flex flex-col shadow my-4 px-3">
        <div class="rounded-lg border border-gray-300 dark:border-gray-700 flex flex-col justify-start p-6">
            ...
            <a href="#" class="text-3xl text-gray-900 dark:text-white font-bold hover:text-gray-700 pb-4">Lorem Ipsum Dolor Sit Amet Dolor Sit Amet</a>
...
{{--    <x-slot name="side">--}}
{{--        <div class="w-full rounded-lg border border-gray-300 dark:border-gray-700 shadow flex flex-col my-4 p-6">--}}
{{--            <p class="text-xl font-semibold pb-5 text-teal-600">About Us</p>--}}
