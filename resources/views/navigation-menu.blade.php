    ...
    <nav class="w-full bg-background/80 py-3 px-4 h-[6.5rem] border-b border-secondary/30">
        <div class="flex justify-between items-center max-w-screen-2xl mx-auto">
            <div class="flex justify-start items-center">
                <!-- Hamburger menu-->
                <button type="button"
                        class="lg:hidden flex items-center bg-background rounded-full h-10 w-10 justify-center text-primary z-50"
                        data-drawer-target="drawer-navigation"
                        data-drawer-toggle="drawer-navigation"
                        aria-controls="drawer-navigation">
                    <span class="sr-only">Open menu</span>
                    <x-lucide-align-left class="w-8 h-8"/>
                </button>
                <x-logo.logo/>
                <!-- Desktop menu -->
                            ...
                            <x-slot name="trigger">
                                @if (Laravel\Jetstream\Jetstream::managesProfilePhotos())
                                    <button class="flex text-sm border-2 border-transparent rounded-full focus:outline-hidden focus:border-gray-300 transition">
                                        <img class="w-10 h-10 rounded-full object-cover aspect-square shrink-0"
