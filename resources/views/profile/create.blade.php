    ...
    <div class="flex flex-col h-full">
        ...
        <div class="h-full w-full flex flex-col items-center justify-center mx-auto">
            <div class="w-full max-w-md">
                <div>
                    <x-heading.main>Accept Invitation</x-heading.main>
                </div>
                <div>
                    <x-card.default class="form">
                        <form method="POST" action="{{ route('accept-invitation.store') }}" class="space-y-6">
                            @csrf
                            <input type="hidden" id="invited_by" name="invited_by"
                                   value="{{ $invitation->invited_by }}">
