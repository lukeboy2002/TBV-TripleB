<div>
    <x-tbv-heading_h5>Browser sesions</x-tbv-heading_h5>
    <x-tbv-action-section>
        <x-slot name="content">
            ...
            <div class="flex items-center mt-5">
                <x-tbv-button wire:click="confirmLogout" wire:loading.attr="disabled">
                    {{ __('Log Out Other Browser Sessions') }}
                </x-tbv-button>

                <x-action-message class="ms-3 flex gap-2" on="loggedOut">
                    <x-lucide-check class="h-5 w-5"/>{{ __('Done.') }}
                </x-action-message>
            </div>
            ...
            <x-dialog-modal wire:model.live="confirmingLogout">
                ...
                <x-slot name="footer">
                    <x-tbv-button_secondary wire:click="$toggle('confirmingLogout')" wire:loading.attr="disabled">
                        {{ __('Cancel') }}
                    </x-tbv-button_secondary>

                    <x-tbv-button class="ms-3"
