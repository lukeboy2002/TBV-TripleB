        ...
        <nav role="navigation" aria-label="Pagination Navigation" class="flex justify-between space-x-2">
            <span>
                ...
                @if ($paginator->onFirstPage())
                    <span class="inline-flex items-center px-2 py-1 bg-button-secondary border border-transparent rounded-md font-semibold text-xs text-secondary/30 uppercase tracking-widest disabled:opacity-50 transition ease-in-out duration-150 select-none">                        <x-lucide-chevrons-left
                                class="w-4 h-4"/>
                    </span>
                @else
            ...
            <span>
                ...
                @if ($paginator->hasMorePages())
                    ...
                    @endif
                @else
                    <span class="inline-flex items-center px-2 py-1 bg-button-secondary border border-transparent rounded-md font-semibold text-xs text-secondary/30 uppercase tracking-widest disabled:opacity-50 transition ease-in-out duration-150 select-none">
                        <x-lucide-chevrons-right class="w-4 h-4"/>
                    </span>
                @endif
            </span>
