                        ...
                        <table class="inner-body" align="center" width="570" cellpadding="0" cellspacing="0"
                            ...
                            <tr>
                                <td class="content-cell" style="max-width: 100vw; padding: 32px;">
                                    ...
                                    <p>Your invited is been removed by <span
                                                class="user">{{ ucfirst( $mailData['deleted_by'] ) }}</span></p>
                                </td>
                            </tr>
                            <tr>
                                <td class="content-cell" style="max-width: 100vw; padding: 32px;">
                                    <p>The previously sent email by TBV-TripleB is no longer valid</p>
                                </td>
                            </tr>
                            <tr>
                                <td class="content-cell" style="max-width: 100vw; padding: 32px;">
                                    <p>Regards,<br><span
                                                class="user">TripleB, {{ ucfirst( $mailData['deleted_by'] ) }}</span>
                                </td>
                            </tr>
                        </table>
                    </td>
